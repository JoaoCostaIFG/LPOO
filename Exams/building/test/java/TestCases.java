...
public class TestCases {
    ...
    @Test
    public void testRoom() throws Exception, DuplicateRoomException {
        Building b = new Building("B", -1, 4);
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testRoomArgs() throws Exception, DuplicateRoomException {
        Building b = new Building("B", -1, 4);
        Room r = new Room(b, "104", 5);
    }

    @Test
    public void testFacility() throws Exception, DuplicateRoomException {
    ...
    @Test
    public void testToString() throws Exception, DuplicateRoomException {
        Building b = new Building("B", -1, 4);
    ...
    @Test
    public void testCapacity() throws Exception, DuplicateRoomException {
        Building b = new Building("B", -1, 4);
    ...
    public void testDuplicateRooms() throws DuplicateRoomException {
        Building b = new Building("B", -1, 4);
	...
	@Test
	public void testUserAccess() throws DuplicateRoomException {
		User u1 = new User("Rui");
		User u2 = new User("Maria");

...
public class TreeTest {
    ...
    public void testTreeCreation() {
        assertEquals(tree.getPlantDate(), date);
        Location loc = tree.getLocation();
        assertEquals(loc.getLatitude(), "41.177772696363114");
        assertEquals(loc.getLongitude(), "-8.59843522310257");
        assertEquals(loc.getName(), "FEUP");
    }
    ...
    public void testTreeSetLocation() {
        ...
        assertEquals(tree.getPlantDate(), date);
        Location loc = tree.getLocation();
        assertEquals(loc.getLatitude(), "loclat");
        assertEquals(loc.getLongitude(), "loclon");
        assertEquals(loc.getName(), "locname");
    }
